...
function GetInTouch() {
    return (
        <section>
            ...
            <p>
                웹 개발 17년 차 정훈입니다. 저는 주로 <a href="#">.NET MVC & MS-SQL</a>을 기반으로 웹 프로그래밍 경력을 쌓아왔씁니다.
                현재는 String Boot & React를 기반으로 웹 개발 역량을 확장 중이며 이 사이트는 저의 첫번째 <a href="#">String Boot & React</a> 프로젝트입니다.
            </p>
            <ul className="contact">
                <li className="icon solid fa-coffee"><Link to={`${import.meta.env.BASE_URL}career`}>이력서 열람</Link></li>
